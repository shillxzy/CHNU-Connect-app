...
export const getActionsByAdmin = (adminId) => api.get(`/Admin/actions/admin/${adminId}`);
export const getActionsByTarget = (targetUserId) => api.get(`/Admin/actions/target/${targetUserId}`);
