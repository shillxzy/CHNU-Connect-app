...
/* =========================
   Schedule
========================= */
export const getScheduleByGroup = (groupId) => api.get(`/Schedule/group/${groupId}`);
...
/* =========================
   SubGroups
========================= */
export const getSubGroups   = (groupId) => api.get(`/Schedule/subgroups/${groupId}`);
export const createSubGroup = (data)    => api.post('/Schedule/subgroups', data);
export const updateSubGroup = (id, data)=> api.put(`/Schedule/subgroups/${id}`, data);
