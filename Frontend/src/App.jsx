...
import ScheduleViewPage from './components/Schedule/ScheduleViewPage'; // ✅ NEW
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/refresh-password" element={<PublicRoute><RefreshPassword /></PublicRoute>} />
      ...
      <Route path="/" element={<ProtectedRoute><HomePage /></ProtectedRoute>}>
        ...
        <Route path="groups/create" element={<AdminRoute><GroupCreate /></AdminRoute>} />
        <Route path="groups/edit/:id" element={<AdminRoute><GroupEdit /></AdminRoute>} />

        {/* ✅ Редагування розкладу — тільки адмін */}
        <Route path="group/edit/schedule/:id" element={<AdminRoute><ScheduleEditPage /></AdminRoute>} />
      </Route>
