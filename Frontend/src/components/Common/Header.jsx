    ...
    <header className="header">
      ...
      <div className="header-right">
        <nav className="header-nav">
          <NavLink to="/" className={(ctx) => navIsActive(ctx)}>
            Головна
          </NavLink>
          <NavLink to="/events" className={(ctx) => navIsActive(ctx)}>
            Події
          </NavLink>
          <NavLink to="/groups" className={(ctx) => navIsActive(ctx)}>
            Групи
          </NavLink>
          <NavLink to="/about" className={(ctx) => navIsActive(ctx)}>
            Про Нас
          </NavLink>
        </nav>
