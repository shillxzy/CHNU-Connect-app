    ...
    const fetchUserAndPosts = async () => {
      try {
        ...
        const postsWithAuthor = userPosts.map((post) => ({
          ...
          authorAvatar:
            userData.photoUrl || '../Icons/default-avatar-profile-icon.png',
        ...
        setError(
          err.response?.data?.message || 'Помилка при завантаженні профілю',
        );
      } finally {
        setLoading(false);
      }
      ...
      <div className="profile-header">
        ...
        <div className="profile-info-actions">
          <div className="profile-details">
            ...
            <p>
              <span className="profile-label">Факультет:</span> {user.faculty}
            </p>
            <p>
              <span className="profile-label">Курс:</span> {user.course}
            </p>
            <p>
              <span className="profile-label">Біо:</span> {user.bio}
            </p>
