...
const NewsFeed = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const postsWithUser = postsData.map((post) => ({
          ...
          authorAvatar:
            post.authorAvatar || '../Icons/default-avatar-profile-icon.png',
  ...
  const handleCreatePost = async () => {
    ...
    try {
      ...
      const newPost = {
        ...
        authorAvatar:
          currentUser.photoUrl || '../Icons/default-avatar-icon.png',
  ...
  return (
    <div className="news-feed-container">
      ...
      <Link to="/posts" className="news-feed-more-button">
        Побачити ще
      </Link>
    </div>
  );
