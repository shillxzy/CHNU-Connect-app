...
Соціальна мережа Чернівецького національного університету ім. Ю.
Федьковича\
Платформа для студентів, викладачів, адміністрації та гостей
університету.
...
**CHNU Connect** --- це університетська соціальна мережа на зразок
поєднання Facebook + Telegram, створена спеціально для екосистеми ЧНУ.

Платформа дозволяє: - переглядати стрічку новин; - створювати та читати
пости; - взаємодіяти через лайки й коментарі; - створювати та
приєднуватися до груп і спільнот; - писати приватні повідомлення; -
переглядати та створювати події; - адмініструвати контент; -
